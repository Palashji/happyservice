...
import com.bluewebspark.happyservice.model.CancelledModel;
...
public class CancelledAdapter extends RecyclerView.Adapter<CancelledAdapter.MyViewHolder> {
    ...
    public CancelledAdapter(Context context, List<CancelledModel> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_cancelled, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final CancelledModel model = arrayList.get(position);
