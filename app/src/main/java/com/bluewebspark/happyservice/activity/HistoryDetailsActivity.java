...
public class HistoryDetailsActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, CustomButtonListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCancelThisJob.setVisibility(View.GONE);
        ...
        new JSONParser(this).parseRetrofitRequest(ApiClient.getClient().create(ApiInterface.class).change_request_status(
            ...
            public void backResponse(String response) {
                ...
                if (!response.equals("error")) {
                    S.T(HistoryDetailsActivity.this, "Your Service Request Completed.");
                    finish();
                }
            }
        });
    ...
    private void cancelJob() {
        new JSONParser(this).parseRetrofitRequest(ApiClient.getClient().create(ApiInterface.class).change_request_status(
            ...
            public void backResponse(String response) {
                ...
                if (!response.equals("error")) {
                    S.T(HistoryDetailsActivity.this, "Your Service Request will be Cancel");
                    finish();
                }
            }
        });
                ...
                if (!response.equals("error")) {
                    try {
                        ...
                        if (jsonObject.getBoolean("status")) {
                            ...
                            S.setImageByPicaso(HistoryDetailsActivity.this, Const.URL.SERVICES_IMAGES + json.getString("serviceImage"), bookingImage, null);
                            ...
                            /*if (arrayListVendor.size() > 0) {
                                ...
                                tvNoData.setVisibility(View.GONE);
                                recycleviewVendorList.setLayoutManager(new LinearLayoutManager(HistoryDetailsActivity.this));
                                BookingsVendorAdapter bookingsVendorAdapter = new BookingsVendorAdapter(HistoryDetailsActivity.this, arrayListVendor);
                                recycleviewVendorList.setAdapter(bookingsVendorAdapter);
                                bookingsVendorAdapter.setCustomButtonListener(HistoryDetailsActivity.this);
    ...
    public void onButtonClick(int position, String buttonText) {
        if (buttonText.equals("chat_btn_click")) {
            if (arrayListVendor.get(position).getVendorStatus().equals("3") || arrayListVendor.get(position).getVendorStatus().equals("4")) {
                ...
                S.I(HistoryDetailsActivity.this, ConversationActivity.class, bundle);
            } else {
